...
def main():
    ...
    # Prompt-free HL-Residual：每 seed 只预测一次，然后复制到所有 sigma
    ...
    json_path = out_dir / "e7a_prompt_drift_residual_metrics.json"
    json_path.write_text(json.dumps(summary, ensure_ascii=False, indent=2), encoding="utf-8")

    fig_path = out_dir / "e7a_prompt_drift_residual_curve.png"
